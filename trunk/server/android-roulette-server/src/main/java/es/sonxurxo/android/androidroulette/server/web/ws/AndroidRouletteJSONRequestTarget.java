 ...
 *
 */
public class AndroidRouletteJSONRequestTarget implements IRequestTarget {

	private JSON response;
	
	public AndroidRouletteJSONRequestTarget(JSON response) {
	...
	public void respond(RequestCycle requestCycle) {
		...
		if (AndroidRouletteSession.get().getId() == null) {
			AndroidRouletteSession.get().bind();
		}
	}
